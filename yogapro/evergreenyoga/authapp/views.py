...
def Asanas(request):
    return render(request,"asanas.html")
...
def attendance(request):
    ...
    if request.method=="POST":
        ...
        Logout=request.POST.get('logoutime')
        SelectAsanas=request.POST.get('asanas')
        TrainedBy=request.POST.get('trainer')
        query=Attendance(phonenumber=phonenumber,Login=Login,Logout=Logout,SelectAsanas=SelectAsanas,TrainedBy=TrainedBy)
        query.save()
